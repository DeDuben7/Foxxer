...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA6     ------> ADC1_INP3
    */
    GPIO_InitStruct.Pin = SA818_AUDIO_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(SA818_AUDIO_OUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA6     ------> ADC1_INP3
    */
    HAL_GPIO_DeInit(SA818_AUDIO_OUT_GPIO_Port, SA818_AUDIO_OUT_Pin);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  if(hdac->Instance==DAC1)
  {
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(SA818_AUDIO_IN_GPIO_Port, SA818_AUDIO_IN_Pin);
