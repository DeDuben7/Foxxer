...
#define ATT_1_GPIO_Port GPIOA
#define ATT_2_Pin GPIO_PIN_2
#define ATT_2_GPIO_Port GPIOA
#define ATT_4_Pin GPIO_PIN_3
#define ATT_4_GPIO_Port GPIOA
#define ATT_8_Pin GPIO_PIN_4
#define ATT_8_GPIO_Port GPIOA
#define ATT_16_Pin GPIO_PIN_5
#define ATT_16_GPIO_Port GPIOA
#define SA818_AUDIO_Pin GPIO_PIN_6
#define SA818_AUDIO_GPIO_Port GPIOA
